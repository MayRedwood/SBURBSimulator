...
Future<void> main() async {
  ...
  if(getParameterByName("seed",null) != null){
    if(getParameterByName("seed",null) == "owowhatsthis") {
      ...
      throw(message);
    }else if(getParameterByName("seed",null) == "bread") {
      String messageBread = "ERROR: UNAUTHORIZED ROOT ACCESS DETECTED.  ASPECT OF VIOLATION DETECTED:  MIND. REPORT <a href = 'http://www.whyistherevolution.simdif.com'>SUBMITTED</a> TO LOCAL LIGHT PLAYER.";
      SimController.instance.storyElement.setInnerHtml("$messageBread <br><Br>");
      AnchorElement b = new AnchorElement(href: "http://www.whyistherevolution.simdif.com")..text = "View Report?";
      SimController.instance.storyElement.append(b);
      throw(messageBread);
    }
