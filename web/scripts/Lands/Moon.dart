...
class Moon extends Land {
  ...
  Carapace get king {
      ...
      return session.battlefield.blackKing; //I love how in this code if the name is ANYTHING BUT PROSPIT you geta a black king
  ...
  Element planetsplode(GameEntity killer) {
      killer.moonKillCount ++; //WHY IS THERE A MOON KILL COUNT THIS IS SO STUPID IN MANY DIFFERENT LEVELS
      ...
      String are = "are"; //wH-WH- oh it's because are/is ha good job JR
