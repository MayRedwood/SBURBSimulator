...
class Mist extends Aspect {
    ...
    @override
    List<String> landNames = new List<String>.unmodifiable(<String>["Quanta", "Mist", "Overlap", "Possibility", "Fog", "Forests", "Water", "Waves", "Instability", "Everything"]);
    ...
    @override
    List<String> denizenNames = new List<String>.unmodifiable(<String>['Mist', 'Minerva', 'Einstein', 'Feymann']);


    @override
    List<String> symbolicMcguffins = ["mist","overlap", "possibility", "patterns", "everything", "forests", "water", "waves"];

    @override
    List<String> physicalMcguffins = ["mist","box", "cat", "computer","water", "deck of cards"];
    ...
    List<AssociatedStat> stats = new List<AssociatedStat>.unmodifiable(<AssociatedStat>[
        ...
        new AssociatedStat(Stats.EXPERIENCE, 0.2, false), //yes, technically it's from an aspect, but it's not NORMAL.
